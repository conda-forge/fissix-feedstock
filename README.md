...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fissix-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2910&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fissix-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fissix` can be installed with:

```
conda install fissix
```

It is possible to list all of the versions of `fissix` available on your platform with:
